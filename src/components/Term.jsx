          ...
          <div className="max-w-6xl mx-auto">
              ...
              <div className="mt-8 space-y-6">
                  ...
                  <section>
                      ...
                      <p className="text-white">
                          All content on this website (including text, images, graphics, and logos) is owned by or licensed to  Elite Wheels Glasgow.
                  ...
                  <section>
                      ...
                      <div className="text-white">
                          <p><strong>Elite Wheels Glasgow</strong></p>
                          <p>Email: <a href="mailto: Tune-itscotland@hotmail.com" className="text-[#e80202] hover:underline"> Tune-itscotland@hotmail.com</a></p>
